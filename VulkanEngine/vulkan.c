...
void CreateVulkanInstance(VkInstance* pVulkanInstance, char* pApplicatioName)
{
	...
	vkApplicationInfo.pApplicationName = pApplicatioName;
	vkApplicationInfo.applicationVersion = API_VERSION;
	vkApplicationInfo.pEngineName = pApplicatioName;
